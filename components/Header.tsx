    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center text-gray-300 hover:text-cyan-400 transition duration-150 ease-in-out"
            >
                {title}
            ...
            {isOpen && (
                <div
                    ...
                    className="absolute left-0 mt-2 py-2 w-48 bg-gray-800 rounded-md shadow-xl z-20 border border-gray-700 animate-fade-in"
                >
                    {children}
                </div>
            )}
