...
export const translations: Translations = {
  ...
  consultation: { en: 'Consultation', hi: 'परामर्श', mr: 'सल्ला', bn: 'পরামর্শ', ta: 'ஆலோசனை', te: 'సంప్రదింపులు', gu: 'પરામર્શ' },
  consultation_title: { en: 'Online Doctor Consultation', hi: 'ऑनलाइन डॉक्टर परामर्श', mr: 'ऑनलाइन डॉक्टर सल्ला', bn: 'অনলাইন ডাক্তার পরামর্শ', ta: 'ஆன்லைன் மருத்துவர் ஆலோசனை', te: 'ఆన్‌లైన్ డాక్టర్ సంప్రదింపులు', gu: 'ઓનલાઇન ડોક્ટર પરામર્શ' },
  consultation_subtitle: { en: 'Connect with experienced doctors from the comfort of your home.', hi: 'अपने घर बैठे अनुभवी डॉक्टरों से जुड़ें।', mr: 'तुमच्या घरच्या आरामात अनुभवी डॉक्टरांशी संपर्क साधा।', bn: 'আপনার বাড়ির আরাম থেকে অভিজ্ঞ ডাক্তারদের সাথে সংযোগ করুন।', ta: 'உங்கள் வீட்டில் இருந்தபடியே அனுபவம் வாய்ந்த மருத்துவர்களுடன் இணையுங்கள்.', te: 'మీ ఇంటి సౌలభ్యం నుండి అనుభవజ్ఞులైన వైద్యులతో కనెక్ట్ అవ్వండి.', gu: 'તમારા ઘરની સુવિધાથી અનુભવી ડોકટરો સાથે જોડાઓ.' },
  book_now: { en: 'Book Now', hi: 'अभी बुक करें', mr: 'आत्ताच बुक करा', bn: 'এখন বুক করুন', ta: 'இப்போது பதிவு செய்யுங்கள்', te: 'ఇప్పుడే బుక్ చేయండి', gu: 'હમણાં બુક કરો' },
  general_physician: { en: 'General Physician', hi: 'सामान्य चिकित्सक', mr: 'सामान्य चिकित्सक', bn: 'সাধারণ চিকিৎসক', ta: 'பொது மருத்துவர்', te: 'సాధారణ వైద్యుడు', gu: 'સામાન્ય ચિકિત્સક' },
  general_physician_desc: { en: 'Consult for common health issues like cold, flu, fever, and digestive problems.', hi: 'सर्दी, फ्लू, बुखार और पाचन संबंधी समस्याओं जैसे सामान्य स्वास्थ्य मुद्दों के लिए परामर्श करें।', mr: 'सर्दी, फ्लू, ताप आणि पचनाच्या समस्यांसारख्या सामान्य आरोग्य समस्यांसाठी सल्ला घ्या.', bn: 'সর্দি, ফ্লু, জ্বর এবং হজমের সমস্যার মতো সাধারণ স্বাস্থ্য সমস্যার জন্য পরামর্শ করুন।', ta: 'சளி, காய்ச்சல், காய்ச்சல் மற்றும் செரிமான பிரச்சனைகள் போன்ற பொதுவான சுகாதார பிரச்சனைகளுக்கு ஆலோசனை செய்யுங்கள்.', te: 'జలుబు, ఫ్లూ, జ్వరం మరియు జీర్ణ సమస్యల వంటి సాధారణ ఆరోగ్య సమస్యల కోసం సంప్రదించండి.', gu: 'શરદી, ફ્લૂ, તાવ અને પાચન સમસ્યાઓ જેવી સામાન્ય આરોગ્ય સમસ્યાઓ માટે સલાહ લો.' },
  dermatologist: { en: 'Dermatologist', hi: 'त्वचा विशेषज्ञ', mr: 'त्वचारोग तज्ञ', bn: 'চর্মরোগ বিশেষজ্ঞ', ta: 'தோல் மருத்துவர்', te: 'చర్మవ్యాధి నిపుణుడు', gu: 'ત્વચારોગ વિજ્ઞાનୀ' },
  dermatologist_desc: { en: 'For skin conditions like acne, eczema, rashes, and hair loss issues.', hi: 'मुंहासे, एक्जिमा, चकत्ते और बालों के झड़ने की समस्याओं जैसी त्वचा की स्थितियों के लिए।', mr: 'मुरुमे, एक्जिमा, पुरळ आणि केस गळण्याच्या समस्यांसारख्या त्वचेच्या स्थितींसाठी.', bn: 'ব্রণ, একজিমা, ফুসকুড়ি এবং চুল পড়ার সমস্যার মতো ত্বকের অবস্থার জন্য।', ta: 'முகப்பரு, அரிக்கும் தோலழற்சி, தடிப்புகள் மற்றும் முடி உதிர்தல் பிரச்சினைகள் போன்ற தோல் நிலைகளுக்கு.', te: 'మొటిమలు, తామర, దద్దుర్లు మరియు జుట్టు రాలడం సమస్యల వంటి చర్మ పరిస్థితుల కోసం.', gu: 'ખીલ, ખરજવું, ફોલ્લીઓ અને વાળ ખરવાની સમસ્યાઓ જેવી ત્વચાની સ્થિતિઓ માટે.' },
  psychiatrist: { en: 'Psychiatrist', hi: 'मनोचिकित्सक', mr: 'मानसोपचारतज्ज्ञ', bn: 'মনোরোগ বিশেষজ্ঞ', ta: 'மனநல மருத்துவர்', te: 'మానసిక వైద్యుడు', gu: 'મનોચિકિત્સક' },
  psychiatrist_desc: { en: 'Get help for mental health concerns like stress, anxiety, depression, and sleep problems.', hi: 'तनाव, चिंता, अवसाद और नींद की समस्याओं जैसे मानसिक स्वास्थ्य संबंधी चिंताओं के لیے सहायता प्राप्त करें।', mr: 'तणाव, चिंता, नैराश्य आणि झोपेच्या समस्यांसारख्या मानसिक आरोग्य समस्यांसाठी मदत मिळवा।', bn: 'মানসিক স্বাস্থ্য উদ্বেগ যেমন স্ট্রেস, উদ্বেগ, বিষণ্নতা এবং ঘুমের সমস্যার জন্য সাহায্য পান।', ta: 'மன அழுத்தம், பதட்டம், மனச்சோர்வு மற்றும் தூக்கப் பிரச்சனைகள் போன்ற மனநலக் கவலைகளுக்கு உதவி பெறுங்கள்.', te: 'ఒత్తిడి, ఆందోళన, నిరాశ మరియు నిద్ర సమస్యల వంటి మానసిక ఆరోగ్య సమస్యలకు సహాయం పొందండి.', gu: 'તણાવ, ચિંતા, હતાશા અને ઊંઘની સમસ્યાઓ જેવી માનસિક સ્વાસ્થ્યની ચિંતાઓ માટે મદદ મેળવો.' },
  pediatrician: { en: 'Pediatrician', hi: 'बाल रोग विशेषज्ञ', mr: 'बालरोगतज्ञ', bn: 'শিশু বিশেষজ্ঞ', ta: 'குழந்தை நல மருத்துவர்', te: 'శిశువైద్యుడు', gu: 'બાળરોગ ચિકિત્સક' },
  pediatrician_desc: { en: 'Expert care for your child\'s health, from newborn to adolescent.', hi: 'नवजात शिशु से लेकर किशोर तक, आपके बच्चे के स्वास्थ्य के लिए विशेषज्ञ देखभाल।', mr: 'तुमच्या मुलाच्या आरोग्यासाठी, नवजात बाळापासून ते किशोरावस्थेपर्यंत तज्ञ काळजी.', bn: 'আপনার সন্তানের স্বাস্থ্যের জন্য বিশেষজ্ঞ যত্ন, নবজাতক থেকে কিশোর পর্যন্ত।', ta: 'உங்கள் குழந்தையின் ஆரோக்கியத்திற்காக, பிறந்த குழந்தை முதல் இளமைப் பருவம் வரை நிபுணர் பராமரிப்பு.', te: 'మీ పిల్లల ఆరోగ్యం కోసం నిపుణుల సంరక్షణ, నవజాత శిశువు నుండి కౌమారదశ వరకు.', gu: 'તમારા બાળકના સ્વાસ્થ્ય માટે નિષ્ણાત સંભાળ, નવજાતથી કિશોર સુધી.' },
  obstetrician_gynecologist: { en: 'Obstetrician/Gynecologist', hi: 'प्रसूति एवं स्त्री रोग विशेषज्ञ', mr: 'प्रसूती आणि स्त्रीरोग तज्ञ', bn: 'স্ত্রীরোগ ও প্রসূতি বিশেষজ্ঞ', ta: 'மகப்பேறியல்/பெண்ணோயியல்', te: 'ప్రసూతి/గైనకాలజిస్ట్', gu: 'પ્રસૂતિશાસ્ત્રી/સ્ત્રીરોગ નિષ્ણાત' },
  obstetrician_gynecologist_desc: { en: "Specialized care for women's health, including pregnancy, childbirth, and gynecological concerns.", hi: 'गर्भावस्था, प्रसव और स्त्रीरोग संबंधी चिंताओं सहित महिलाओं के स्वास्थ्य के लिए विशेष देखभाल।', mr: 'गर्भधारणा, बाळंतपण आणि स्त्रीરોગविषयक चिंतांसह महिलांच्या आरोग्यासाठी विशेष काळजी.', bn: 'গর্ভাবস্থা, প্রসব এবং গাইনোকোলজিক্যাল উদ্বেগ সহ মহিলাদের স্বাস্থ্যের জন্য বিশেষ যত্ন।', ta: 'கர்ப்பம், பிரசவம் மற்றும் மகளிர் நோய் संबंधी கவலைகள் உட்பட பெண்களின் ஆரோக்கியத்திற்கான சிறப்புப் பராமரிப்பு.', te: 'గర్భం, ప్రసవం మరియు గైనకాలజికల్ సమస్యలతో సహా మహిళల ఆరోగ్యం కోసం ప్రత్యేక శ్రద్ధ.', gu: 'ગર્ભાવસ્થા, બાળજન્મ અને સ્ત્રીરોગ સંબંધી ચિંતાઓ સહિત મહિલાઓના સ્વાસ્થ્ય માટે વિશિષ્ટ સંભાળ.' },
  // Auth Modal
  ...
  doctor_quotes_title: { en: 'Wisdom from Health Experts', hi: 'स्वास्थ्य विशेषज्ञों से ज्ञान', mr: 'आरोग्य तज्ञांकडून ज्ञान', bn: 'স্বাস্থ্য বিশেষজ্ঞদের কাছ থেকে জ্ঞান', ta: 'சுகாதார நிபுணர்களிடமிருந்து ஞானம்', te: 'ఆరోగ్య నిపుణుల నుండి జ్ఞానం', gu: 'આરોગ્ય નિષ્ણાતો પાસેથી જ્ઞાન' },
  doctor_quotes_subtitle: { en: 'Inspirational words from leading medical professionals in India.', hi: 'भारत में अग्रणी चिकित्सा पेशेवरों से प्रेरणादायक शब्द।', mr: 'भारतातील अग्रगण्य वैद्यकीय व्यावसायिकांकडून प्रेरणादायी शब्द.', bn: 'ভারতের নেতৃস্থানীয় চিকিৎসা পেশাদারদের কাছ থেকে অনুপ্রেরণামূলক শব্দ।', ta: 'இந்தியாவின் முன்னணி மருத்துவ நிபுணர்களிடமிருந்து ஊக்கமளிக்கும் வார்த்தைகள்.', te: 'భారతదేశంలోని ప్రముఖ వైద్య నిపుణుల నుండి ప్రేరణాత్మక మాటలు.', gu: 'ભારતના અગ્રણી તબીબી વ્યાવસાયિકો પાસેથી પ્રેરણાદાયક શબ્દો.' },
  ...
  about_rev_subtitle: { en: 'Making quality healthcare accessible to everyone, everywhere', hi: 'गुणवत्तापूर्ण स्वास्थ्य सेवा को सभी के लिए, हर जगह सुलभ बनाना', mr: 'गुणवत्तेची आरोग्यसेवा प्रत्येकासाठी, सर्वत्र उपलब्ध करून देणे', bn: 'সকলের জন্য, সর্বত্র মানসম্মত স্বাস্থ্যসেবা সহজলভ্য করা', ta: 'தரமான சுகாதாரத்தை அனைவருக்கும், எல்லா இடങ്ങളിലും அணுகக்கூடியதாக மாற்றுதல்', te: 'నాణ్యమైన ఆరోగ్య సంరక్షణను అందరికీ, ప్రతిచోటా అందుబాటులో ఉంచడం', gu: 'ગુણવત્તાયુક્ત આરોગ્યસંભાળ દરેક માટે, દરેક જગ્યાએ સુલભ બનાવવી' },
  about_tech_title: { en: 'Advanced AI Technology', hi: 'उन्नत एआई प्रौद्योगिकी', mr: 'प्रगत এआय तंत्रज्ञान', bn: 'উন্নত এআই প্রযুক্তি', ta: 'மேம்பட்ட AI தொழில்நுட்பம்', te: 'అధునాతన AI టెక్నాలజీ', gu: 'અદ્યતન AI ટેકનોલોજી' },
  ...
  // Chatbot
  chatbot_placeholder: { en: "Ask a health question or say 'Go to Dashboard'...", hi: "स्वास्थ्य प्रश्न पूछें या 'डैशबोर्ड पर जाएं' कहें...", mr: "आरोग्य प्रश्न विचारा किंवा 'डॅशबोर्डवर जा' म्हणा...", bn: "একটি স্বাস্থ্য প্রশ্ন জিজ্ঞাসা করুন বা বলুন 'ড্যাশবোর্ডে যান'...", ta: "சுகாதாரக் கேள்வியைக் கேட்கவும் அல்லது 'டாஷ்போர்டுக்குச் செல்' என்று கூறவும்...", te: "ఆరోగ్య ప్రశ్న అడగండి లేదా 'డాష్‌బోర్డ్‌కు వెళ్లండి' అని చెప్పండి...", gu: "આરોગ્ય પ્રશ્ન પૂછો અથવા 'ડેશબોર્ડ પર જાઓ' કહો..." },
  navigating_message: { en: 'Navigating to {page}...', hi: '{page} पर नेविगेट कर रहे हैं...', mr: '{page} वर नेव्हिगेट करत आहे...', bn: '{page} এ নেভিগেট করা হচ্ছে...', ta: '{page} க்குச் செல்கிறது...', te: '{page}కి నావిగేట్ చేస్తోంది...', gu: '{page} પર નેવિગેટ કરી રહ્યું છે...' },
  ...
  speech_error_no_speech: { en: "I didn't hear anything. Could you please try again?", hi: 'मुझे कुछ सुनाई नहीं दिया। क्या आप कृपया फिर से प्रयास कर सकते हैं?', mr: 'मला काही ऐकू आले नाही. कृपया पुन्हा प्रयत्न करा.', bn: 'আমি কিছু শুনতে পাইনি। আপনি আবার চেষ্টা করতে পারেন?', ta: 'எனக்கு எதுவும் கேட்கவில்லை. மீண்டும் முயற்சிக்கவும்.', te: 'నాకు ఏమీ వినిపించలేదు. దయచేసి మళ్ళీ ప్రయత్నించండి.', gu: 'મને કંઈ સંભળાયું નહીં. કૃપા કરીને ફરીથી પ્રયાસ કરો.' },
  speech_error_not_allowed: { en: "I can't access your microphone. Please check your browser permissions.", hi: 'मैं आपके माइक्रोफ़ोन तक नहीं पहुँच सकता। कृपया अपनी ब्राउज़र अनुमतियाँ जाँचें।', mr: 'मी तुमचा मायक्रोफोन ऍक्सेस करू शकत नाही. कृपया तुमच्या ब्राउझर परवानग्या तपासा.', bn: 'আমি আপনার মাইক্রোফোন অ্যাক্সেস করতে পারছি না। অনুগ্রহ করে আপনার ব্রাউজার অনুমতিগুলি পরীক্ষা করুন।', ta: 'உங்கள் மைக்ரோஃபோனை என்னால் அணுக முடியவில்லை. உங்கள் உலாவி அனுமதிகளைச் சரிபார்க்கவும்.', te: 'నేను మీ మైక్రోఫోన్‌ను యాక్సెస్ చేయలేను. దయచేసి మీ బ్రౌజర్ అనుమతులను తనిఖీ చేయండి.', gu: 'હું તમારા માઇક્રોફોનને ઍક્સેસ કરી શકતો નથી. કૃપા કરીને તમારી બ્રાઉઝર પરવાનગીઓ તપાસો.' },
  speech_error_network: { en: 'A network error occurred during speech recognition. Please check your connection.', hi: 'वाक् पहचान के दौरान एक नेटवर्क त्रुटि हुई। कृपया अपना कनेक्शन जांचें।', mr: 'स्पीच रेकग्निशन दरम्यान नेटवर्क त्रুটি आली. कृपया तुमचे कनेक्शन तपासा.', bn: 'স্পিচ স্বীকৃতির সময় একটি নেটওয়ার্ক ত্রুটি ঘটেছে। অনুগ্রহ করে আপনার সংযোগ পরীক্ষা করুন।', ta: 'பேச்சு அங்கீகாரத்தின் போது ஒரு பிணையப் பிழை ஏற்பட்டது. உங்கள் இணைப்பைச் சரிபார்க்கவும்.', te: 'స్పీచ్ రికగ్నిషన్ సమయంలో నెట్‌వర్క్ లోపం సంభవించింది. దయచేసి మీ కనెక్షన్‌ని తనిఖీ చేయండి.', gu: 'વાણી ઓળખ દરમિયાન નેટવર્ક ભૂલ આવી. કૃપા કરીને તમારું કનેક્શન તપાસો.' },
  // Dashboard
  ...
  // Settings Modal
  settings: { en: 'Settings', hi: 'सेटिंग्स', mr: 'सेटिंग्ज', bn: 'সেটিংস', ta: 'அமைப்புகள்', te: 'సెట్టింగ్‌లు', gu: 'સેટિંગ્સ' },
  voice_language: { en: 'Voice & Language', hi: 'आवाज और भाषा', mr: 'आवाज आणि भाषा', bn: 'ভয়েস এবং ভাষা', ta: 'குரல் மற்றும் மொழி', te: 'వాయిస్ & భాష', gu: 'અવાજ અને ભાષા' },
  speech_language: { en: 'Speech Recognition Language', hi: 'वाक् पहचान भाषा', mr: 'उच्चार ओळख भाषा', bn: 'স্পিচ রিকগনিশন ভাষা', ta: 'பேச்சு அங்கீகார மொழி', te: 'స్పీచ్ రికగ్నిషన్ భాష', gu: 'વાણી ઓળખ ભાષા' },
  spoken_responses: { en: 'Spoken Responses', hi: 'बोले गए जवाब', mr: 'बोललेले प्रतिसाद', bn: 'কথ্য প্রতিক্রিয়া', ta: 'பேசப்பட்ட பதில்கள்', te: 'మాట్లాడే ప్రతిస్పందనలు', gu: 'બોલાયેલ પ્રતિસાદ' },
  wake_word: { en: 'Wake Word', hi: 'वेक वर्ड', mr: 'वेक वर्ड', bn: 'ওয়েক ওয়ার্ড', ta: 'வேக் வார்த்தை', te: 'వేక్ వర్డ్', gu: 'વેક વર્ડ' },
  custom_wake_word: { en: 'Custom Wake Word', hi: 'कस्टम वेक वर्ड', mr: 'सानुकूल वेक वर्ड', bn: 'কাস্টম ওয়েক ওয়ার্ড', ta: 'தனிப்பயன் வேக் வார்த்தை', te: 'కస్టమ్ వేక్ వర్డ్', gu: 'કસ્ટમ વેક વર્ડ' },
  wake_word_desc: { en: 'Note: This feature is in development and requires browser support for activation.', hi: 'नोट: यह सुविधा विकास में है और सक्रियण के लिए ब्राउज़र समर्थन की आवश्यकता है।', mr: 'टीप: हे वैशिष्ट्य विकासात आहे आणि सक्रिय करण्यासाठी ब्राउझर समर्थनाची आवश्यकता आहे.', bn: 'দ্রষ্টব্য: এই বৈশিষ্ট্যটি বিকাশের অধীনে রয়েছে এবং সক্রিয়করণের জন্য ব্রাউজার সমর্থন প্রয়োজন।', ta: 'குறிப்பு: இந்த அம்சம் உருவாக்கத்தில் உள்ளது மற்றும் செயல்படுத்தலுக்கு உலாவி ஆதரவு தேவை.', te: 'గమనిక: ఈ ఫీచర్ అభివృద్ధిలో ఉంది మరియు యాక్టివేషన్ కోసం బ్రౌజర్ మద్దతు అవసరం.', gu: 'નોંધ: આ સુવિધા વિકાસ હેઠળ છે અને સક્રિયકરણ માટે બ્રાઉઝર સપોર્ટની જરૂર છે.' },
  save: { en: 'Save', hi: 'सहेजें', mr: 'जतन करा', bn: 'সংরক্ষণ', ta: 'சேமி', te: 'సేవ్ చేయి', gu: 'સાચવો' },
  manage_data: { en: 'Manage Data', hi: 'डेटा प्रबंधित करें', mr: 'डेटा व्यवस्थापित करा', bn: 'ডেটা পরিচালনা করুন', ta: 'தரவை நிர்வகி', te: 'డేటాను నిర్వహించండి', gu: 'ડેટા મેનેજ કરો' },
  view_manage_history: { en: 'View & Manage History', hi: 'इतिहास देखें और प्रबंधित करें', mr: 'इतिहास पहा आणि व्यवस्थापित करा', bn: 'ইতিহাস দেখুন এবং পরিচালনা করুন', ta: 'வரலாற்றைக் காணலாம் மற்றும் நிர்வగிக்கலாம்', te: 'చరిత్రను వీక్షించండి & నిర్వహించండి', gu: 'ઇતિહાસ જુઓ અને મેનેજ કરો' },
  clear_all_history: { en: 'Clear All Chat History', hi: 'सभी चैट इतिहास साफ़ करें', mr: 'सर्व गप्पांचा इतिहास साफ करा', bn: 'সমস্ত চ্যাট ইতিহাস সাফ করুন', ta: 'அனைத்து அரட்டை வரலாற்றையும் அழிக்கவும்', te: 'అన్ని చాట్ చరిత్రను క్లియర్ చేయండి', gu: 'બધો ચેટ ઇતિહાસ સાફ કરો' },
  confirm_clear_history_title: { en: 'Are you sure?', hi: 'क्या आप निश्चित हैं?', mr: 'तुम्हाला खात्री आहे?', bn: 'আপনি কি নিশ্চিত?', ta: 'உங்களுக்கு நிச்சயமாகத் தெரியுமா?', te: 'మీరు ఖచ్చితంగా ఉన్నారా?', gu: 'તમને ખાતરી છે?' },
  confirm_clear_history_desc: { en: 'This will permanently delete all your chat sessions. This action cannot be undone.', hi: 'यह आपके सभी चैट सत्रों को स्थायी रूप से हटा देगा। यह कार्रवाई पूर्ववत नहीं की जा सकती।', mr: 'हे तुमचे सर्व गप्पा सत्र कायमचे हटवेल. ही क्रिया पूर्ववत केली जाऊ शकत नाही.', bn: 'এটি আপনার সমস্ত চ্যাট সেশন স্থায়ীভাবে মুছে ফেলবে। এই ক্রিয়াটি পূর্বাবস্থায় ফেরানো যাবে না।', ta: 'இது உங்கள் அனைத்து அரட்டை அமர்வுகளையும் நிரந்தரமாக நீக்கும். இந்த செயலைச் செயல்தவிர்க்க முடியாது.', te: 'ఇది మీ అన్ని చాట్ సెషన్‌లను శాశ్వతంగా తొలగిస్తుంది. ఈ చర్యను అన్డు చేయಲಾಗదు.', gu: 'આ તમારા બધા ચેટ સત્રોને કાયમ માટે કાઢી નાખશે. આ ક્રિયાને પૂર્વવત્ કરી શકાતી નથી.' },
  cancel: { en: 'Cancel', hi: 'रद्द करें', mr: 'रद्द करा', bn: 'বাতিল করুন', ta: 'ரத்துசெய்', te: 'రద్దు చేయండి', gu: 'રદ કરો' },
  clear_history_button: { en: 'Yes, Clear History', hi: 'हाँ, इतिहास साफ़ करें', mr: 'होय, इतिहास साफ करा', bn: 'হ্যাঁ, ইতিহাস সাফ করুন', ta: 'ஆம், வரலாற்றை அழிக்கவும்', te: 'అవును, చరిత్రను క్లియర్ చేయండి', gu: 'હા, ઇતિહાસ સાફ કરો' },
  listening: { en: 'Listening...', hi: 'सुन रहा है...', mr: 'ऐकत आहे...', bn: 'শুনছি...', ta: 'கேட்கிறது...', te: 'వినడం...', gu: 'સાંભળી રહ્યું છે...' },
};
...
export const GeneralPhysicianIcon = () => (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z" /></svg>
);
export const DermatologistIcon = () => (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 0v-2m0 8c4.42 0 8-3.58 8-8s-3.58-8-8-8-8 3.58-8-8 3.58 8 8 8zm0 0c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm-4-4h8m-4 0v-4" /></svg>
);
export const PsychiatristIcon = () => (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.5 10.5c0 3.038-2.462 5.5-5.5 5.5s-5.5-2.462-5.5-5.5c0-1.27.426-2.44 1.15-3.395M12 21c-4.97 0-9-4.03-9-9s4.03-9 9-9c4.18 0 7.75 2.84 8.74 6.57M18 10h4m-2-2v4" /></svg>
);
export const PediatricianIcon = () => (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H9a4 4 0 01-4-4V8a4 4 0 014-4h6a4 4 0 014 4v9a4 4 0 01-4 4zm-3-11v2m0 2v2m-2-2h2m2 0h-2" /></svg>
);
export const ObstetricianGynecologistIcon = () => (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <circle cx="12" cy="8" r="4" strokeWidth="2" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 12v8m-3-3h6" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v4m-2-2h4" />
    </svg>
);
