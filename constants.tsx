...
export const translations: Translations = {
  ...
  services: { en: 'Services', hi: 'सेवाएं', mr: 'सेवा', bn: 'সেবা', ta: 'சேவைகள்', te: 'సేవలు', gu: 'સેવાઓ' },
  resources: { en: 'Resources', hi: 'संसाधन', mr: 'संसाधने', bn: 'সম্পদ', ta: 'வளங்கள்', te: 'వనరులు', gu: 'સંસાધનો' },
  alerts: { en: 'Alerts', hi: 'चेतावनी', mr: 'सूचना', bn: 'সতর্কতা', ta: 'எச்சரிக்கைகள்', te: 'హెచ్చరికలు', gu: 'ચેતવણીઓ' },
