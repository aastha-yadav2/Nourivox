...
export const translations: Translations = {
  ...
  navigating_message: { en: 'Navigating to {page}...', hi: '{page} पर नेविगेट कर रहे हैं...', mr: '{page} वर नेव्हिगेट करत आहे...', bn: '{page} এ নেভিগেট করা হচ্ছে...', ta: '{page} க்குச் செல்கிறது...', te: '{page}కి నావిగేట్ చేస్తోంది...', gu: '{page} પર નેવિਗੇટ કરી રહ્યું છે...' },
  ...
  view_manage_history: { en: 'View & Manage History', hi: 'इतिहास देखें और प्रबंधित करें', mr: 'इतिहास पहा आणि व्यवस्थापित करा', bn: 'ইতিহাস দেখুন এবং পরিচালনা করুন', ta: 'வரலாற்றைக் காணலாம் மற்றும் நிர்வகிக்கலாம்', te: 'చరిత్రను వీక్షించండి & నిర్వహించండి', gu: 'ઇતિહાસ જુઓ અને મેનેજ કરો' },
