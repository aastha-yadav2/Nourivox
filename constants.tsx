...
export const translations: Translations = {
  ...
  speech_error_network: { en: 'A network error occurred during speech recognition. Please check your connection.', hi: 'वाक् पहचान के दौरान एक नेटवर्क त्रुटि हुई। कृपया अपना कनेक्शन जांचें।', mr: 'स्पीच रेकग्निशन दरम्यान नेटवर्क त्रुटी आली. कृपया तुमचे कनेक्शन तपासा.', bn: 'স্পিচ স্বীকৃতির সময় একটি নেটওয়ার্ক ত্রুটি ঘটেছে। অনুগ্রহ করে আপনার সংযোগ পরীক্ষা করুন।', ta: 'பேச்சு அங்கீகாரத்தின் போது ஒரு பிணையப் பிழை ஏற்பட்டது. உங்கள் இணைப்பைச் சரிபார்க்கவும்.', te: 'స్పీచ్ రికగ్నిషన్ సమయంలో నెట్‌వర్క్ లోపం సంభవించింది. దయచేసి మీ కనెక్షన్‌ని తనిఖీ చేయండి.', gu: 'વાણી ઓળખ દરમિયાન નેટવર્ક ભૂલ આવી. કૃપા કરીને તમારું કનેક્શન તપાસો.' },
  // Dashboard
